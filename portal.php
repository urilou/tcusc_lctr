...
//include("simple_html_dom.php");
  $portal_html = file_get_html("https://sav-web.off.tcu.ac.jp/campusp/sservice/start.do");
  ...
  for ($run_length=1; $run_length<$portal_data_length + 1; $run_length++) {
    ...
    $data_item1 = str_replace('javascript:openKouhou(\'', 'https://sav-web.off.tcu.ac.jp/campusp/sservice/', $data_item1);
  ...
  $portal_api_v3 = "{\"name\":\"都市大SCポータル情報(全件)\",\n\"ver\":{\"this\":\"3\",\"last\":\"3\"},\n\"update\":\"".date('Y/n/j H:i:s')."\",\n\"inserted\":\"".count($diff)."\",\n\"data\":[\n".$portal_api_v3."\n]}";
