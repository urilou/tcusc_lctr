<?php
  ...
  $html = file_get_html("https://sav-web.off.tcu.ac.jp/campusp/sservice/start.do");
  $tweetfilepath = '/home/users/1/mods.jp-usi/web/tcusc_lctr/tcu-new.txt';
  $oldatfilepath = '/home/users/1/mods.jp-usi/web/tcusc_lctr/tcu-all.txt';
...
echo 'すべてのお知らせデータ数: '.$tyitm.'<br>';
    ...
    for ($ty=1; $ty<$tyitm+1; $ty++) {
        ...
        $ityn1 = str_replace('javascript:openKouhou(\'', 'https://sav-web.off.tcu.ac.jp/campusp/sservice/', $ityn1);
